...
int main(int argc, char *argv[]){	
	...
	pthread_t south_t,north_t;
	pthread_create(&north_t,NULL,northtosouth,NULL);
	pthread_create(&south_t,NULL,southtonorth,NULL);
